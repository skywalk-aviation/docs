...
project = 'SkyWalk'
copyright = '2026, Erdogan Taskesen'
...
release = 'SkyWalk'
#version = str(skywalk.__version__)
version = "1.0.0"
...
pdf_documents = [('index', u'skywalk', u'skywalk', u'Erdogan Taskesen'),]
...
html_css_files = ['css/custom.css','css/style_tutorial.css']
...
# Disable the generated index and the domain/module indices
